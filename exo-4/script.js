...
const EasilySecretMessage = secretMessage[secretMessage.indexOf('right')] = "easily" // Remplace l'entrée 5 de mon array par "easily"
const unshiftedSecretMessage = secretMessage.unshift('Programming') // Ajoute la première entrée de l'array
const splicedSecretMessage = secretMessage.splice(secretMessage.indexOf(5), 5, 'know'); // Remplace l'entrée 5 de l'array, 5 valeurs, 'know'
